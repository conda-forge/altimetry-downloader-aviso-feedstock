...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/altimetry-downloader-aviso-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/altimetry-downloader-aviso-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add altimetry-downloader-aviso
# for installing globally
pixi global install altimetry-downloader-aviso
```
...
It is possible to list all of the versions of `altimetry-downloader-aviso` available on your platform:
...
```
pixi search altimetry-downloader-aviso --channel conda-forge
```
